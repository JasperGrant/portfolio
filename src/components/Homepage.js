...
export default function Homepage() {
    return (
        <div className="md:px-24 lg:px-96 bg-center bg-no-repeat bg-DALCampus text-white text-center">
            ...
            <br/>
            <div className=" rounded-lg bg-neutral text-center border-8 border-turquoise">
                <br/>
            ...
            <br/>
            <Link to="projects"
                  className=" rounded-lg bg-neutral text-center px-3 py-2 border-8 hover:text-white text-turquoise">Click
                here to see
                my projects</Link>
            <br/>
            <br/>
